...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#1a1a4e', padding: 20, alignItems: 'center' },
  title: { fontSize: 24, fontWeight: 'bold', paddingHorizontal: 120, padding: 10, backgroundColor: '#1a1a2e', color: '#fff', textAlign: 'center', marginBottom: 20, borderRadius: 200 },
